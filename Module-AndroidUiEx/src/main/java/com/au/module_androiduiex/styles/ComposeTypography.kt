...
object ComposeTypography {
    ...
    val Font14Tertiary @Composable @ReadOnlyComposable get() = composeTextStyleWithoutLineHeight(14.sp, color = ComposeColors.TextTertiary)
    ...
    val Font16Tertiary @Composable @ReadOnlyComposable get() = composeTextStyleWithoutLineHeight(16.sp, color = ComposeColors.TextTertiary)
    ...
    val Font14WhiteRegular @Composable @ReadOnlyComposable get() = composeTextStyleWithoutLineHeight(14.sp, fontFamily = RegularFontFamily, color = Color.White)
