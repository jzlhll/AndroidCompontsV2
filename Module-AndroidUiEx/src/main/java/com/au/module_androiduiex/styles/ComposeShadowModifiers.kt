...
/** 阴影白底块。 */
fun Modifier.composeShadowWhiteBlock(): Modifier = drawWithCache {
    ...
    val paint = android.graphics.Paint(android.graphics.Paint.ANTI_ALIAS_FLAG).apply {
        ...
        color = ComposeColors.ShadowDefault.toArgb()
    ...
    .background(ComposeColors.WhiteBlockBackground, ComposeShadowBlockShape)
