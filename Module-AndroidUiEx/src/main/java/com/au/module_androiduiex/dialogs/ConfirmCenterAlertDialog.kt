...
import com.au.module_androiduiex.databinding.ConfirmCenterAlertDialogBinding

open class ConfirmCenterAlertDialog : BindingDialog<ConfirmCenterAlertDialogBinding>() {
    companion object {
        fun show(
            ...
            sureClick: Function1<ConfirmCenterAlertDialog, Unit>?,
        ): ConfirmCenterAlertDialog {
            val dialog = ConfirmCenterAlertDialog()
            dialog.onShownBlock = {
