...
public class CameraV2Renderer implements GLSurfaceView.Renderer {
    ...
    final CameraV2GLSurfaceView mCameraV2GLSurfaceView;
    final CameraV2 mCamera;
    ...
    public CameraV2Renderer(CameraV2GLSurfaceView surfaceView, CameraV2 camera, boolean isPreviewStarted, Context context) {
        mContext = context;
