...
import com.au.module_androidui.ui.views.IHasToolbar
 ...
 * 2. 处理是否显示右侧的menu列表
 */
open class TitleAndMenuManager(private val fragment: Fragment,
    ...
    fun setTitleAlign(isCenter: Boolean) {
        ...
        uiHelper.toolbar?.asOrNull<MaterialToolbar>()?.isTitleCentered = isCenter
    }
