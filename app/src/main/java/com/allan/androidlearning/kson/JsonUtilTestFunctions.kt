...
class JsonUtilTestFunctions {
    ...
    fun testToStringSimpleTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            val bean = _1SerializableBean("avatar_url", 123456789L, "test@email.com")
            codeStr = """
            ...
            """.trimIndent()
            val str = bean.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringListAnnotatedTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            val list = listOf(_1SerializableBean("a1", 1L, "e1"), _1SerializableBean("a2", 2L, "e2"))
            codeStr = """
            ...
            """.trimIndent()
            val str = list.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam List Annotated $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringListNormalTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = list.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Normal $str" }
            return codeStr to str
        } catch (e: Exception) {
            logdNoFile("🌟kson") { "toKsonStringNoParam Normal failed: $e" }
            return codeStr to e.message
        }
    }
    ...
    fun testToStringListStrNormalTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = list.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam List Str $str" }
            return codeStr to str
        } catch (e: Exception) {
            logdNoFile("🌟kson") { "toKsonStringNoParam List Str failed: $e" }
            return codeStr to e.message
        }
    }
    ...
    fun testToStringMapAnnotatedTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = map.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Map Annotated $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringMapNormalTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = map.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Map Normal $str" }
            return codeStr to str
        } catch (e: Exception) {
            logdNoFile("🌟kson") { "toKsonStringNoParam Map Normal failed: $e" }
            return codeStr to e.message
        }
    }
    ...
    fun testToStringMapSimpleTypedNoParam(): Pair<String, String?> {
        ...
        try {
            ...
            """.trimIndent()
            val str = map.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Map Simple (String only) $str" }
            return codeStr to str
        } catch (e: Exception) {
            logdNoFile("🌟kson") { "toKsonStringNoParam Map Simple failed: $e" }
            return codeStr to e.message
        }
    }
    ...
    fun testToStringGenericCustomAnnotatedTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = bean.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Generic Annotated $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringGenericCustomNormalTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = bean.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Generic Normal $str" }
            return codeStr to str
        } catch (e: Exception) {
            logdNoFile("🌟kson") { "toKsonStringNoParam Generic Normal failed: $e" }
            return codeStr to e.message
        }
    }
    ...
    fun testToStringNestedGenericListTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = bean.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Nested List $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringNestedMapListTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = map.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Nested MapList $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringNestedListGenericTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            ...
            """.trimIndent()
            val str = list.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam Nested ListGeneric $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringDeepNestFieldTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            val inner = _1SerializableBean("dn1", 600L, "dne1")
            val bean = _3SerializableNestBean(outInfo = "out1", serverTime = 999L, data = inner)
            ...
            """.trimIndent()
            val str = bean.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam DeepNest Field $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringDeepNestListTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            val list = listOf(_1SerializableBean("dnl1", 700L, "dnle1"))
            val bean = _3SerializableNestBean(outInfo = "out2", serverTime = 888L, dataList = list)
            ...
            """.trimIndent()
            val str = bean.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam DeepNest List $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
    ...
    fun testToStringDeepNestMapTypedNoParam(): Pair<String, String?> {
        var codeStr = ""
        try {
            val map = mapOf("k_dnm" to _1SerializableBean("dnm1", 800L, "dnme1"))
            val bean = _3SerializableNestBean(outInfo = "out3", serverTime = 777L, dataMap = map)
            ...
            """.trimIndent()
            val str = bean.toKsonString()
            logdNoFile("🌟kson") { "toKsonStringNoParam DeepNest Map $str" }
            return codeStr to str
        } catch (e: Exception) {
            e.printStackTrace()
            return codeStr to e.message
