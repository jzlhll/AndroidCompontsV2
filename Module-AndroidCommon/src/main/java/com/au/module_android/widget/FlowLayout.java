 ...
 * flChildSpacingForLastRow	auto/align/dimension
 ...
 *
 * align in childSpacingForLastRow means that the horizontal spacing of the child views in the last row keeps the same with the spacing used in the row above.
 * If there is only one row in FlowLayout and the childSpacingForLastRow is set to align, this value is ignored and the actual spacing is calculated using childSpacing.
 */
